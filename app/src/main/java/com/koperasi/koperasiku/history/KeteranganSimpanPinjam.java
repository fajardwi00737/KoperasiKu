...
public class KeteranganSimpanPinjam extends AppCompatActivity {
    private TextView textHasil;
    private RequestQueue mQueue;
    String url = "http://192.168.5.25/transaksi/jalan.php";
    @Override
