...
public class TambahAnggota extends AppCompatActivity  implements View.OnClickListener{
    ...
    private void addEmployee(){
        ...
        class AddEmployee extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... v) {
                ...
                params.put(konfigurasi.KEY_EMP_DAERAH,daerah);
                params.put(konfigurasi.KEY_EMP_KAMAR,kamar);
                params.put(konfigurasi.KEY_EMP_SALDO,saldo);
    ...
    public void onClick(View v) {
        ...
        if(v == buttonView){
            startActivity(new Intent(this,Anggota.class));
        }
    }
}
